...
description: |
  Dev workflow entry point. Use when starting new work or resuming an existing work item. Owns intent capture, scope sizing, design approval, plan review, and redesign routing. Spawn with `meridian spawn -a product-manager`, passing requirements or context.
skills:
- agent-management
- meridian-spawn
- session-mining
