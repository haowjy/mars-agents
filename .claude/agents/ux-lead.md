...
name: ux-lead
description: |
  Visual design and UX entry point. Use when work needs visual direction, layout exploration, or design iteration with the user. Works directly with the user to explore layouts, refine aesthetics, and converge on a look and feel through rapid mockup iteration. Spawn with `meridian spawn -a ux-lead`.
