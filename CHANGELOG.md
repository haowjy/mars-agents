...
### Changed
- Launch-bundle auto-routing defaults to `harness_order = ["claude", "codex", "pi", "opencode", "cursor"]` when `settings.harness_order` is unset (explicit empty/invalid still falls through).
