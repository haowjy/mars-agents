...
| `model-policies` (implicit order, optional `no-fallback`) | dropped | meridian-only |
...
| `autocompact`, `autocompact-pct`, `model-policies` (implicit order, optional `no-fallback`) | dropped | meridian-only |
...
| `model-policies` (implicit order, optional `no-fallback`) | preserved | meridian-only | meridian-only | meridian-only | meridian-only |
