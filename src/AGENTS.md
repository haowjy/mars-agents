...
- `discover/` owns source item discovery: a bounded convention walk over non-hidden package layers (including whole hook directories); see `src/discover/.context/CONTEXT.md`
