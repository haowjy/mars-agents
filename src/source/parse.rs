...
mod tests {
    ...
    fn parse_matrix_examples() {
        ...
        let cases = [
            ...
            Case {
                input: "meridian-flow/meridian-base",
                format: SourceFormat::GitHubShorthand,
                url: Some("https://github.com/meridian-flow/meridian-base"),
                path: None,
                version: None,
                name: "meridian-base",
            },
            Case {
                input: "meridian-flow/meridian-base@v1.0",
                format: SourceFormat::GitHubShorthand,
                url: Some("https://github.com/meridian-flow/meridian-base"),
                path: None,
                version: Some("v1.0"),
            ...
            Case {
                input: "github.com/meridian-flow/meridian-base",
            ...
            Case {
                input: "github.com/meridian-flow/meridian-base@latest",
                format: SourceFormat::BareDomain,
                url: Some("https://github.com/meridian-flow/meridian-base"),
                path: None,
                version: Some("latest"),
