...
mod tests {
    ...
    fn make_locked_item(
        ...
        LockedItem {
            ...
            installed_checksum: installed_checksum.to_string(),
            dest_path,
        }
    }
    ...
    fn orphan_detected() {
        ...
        let mut lock_items = IndexMap::new();
        lock_items.insert("agents/old-agent.md".to_string(), locked_item);
        let lock = LockFile {
            version: 1,
            sources: IndexMap::new(),
            items: lock_items,
